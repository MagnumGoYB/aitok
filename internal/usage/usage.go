...
const (
	...
	InputIncludesCached InputCostMode = "includes_cached"
	InputExcludesCached InputCostMode = "excludes_cached"
)
...
type UsageEvent struct {
	...
	InputCostMode       InputCostMode `json:"input_cost_mode,omitempty"`
	Complete            bool          `json:"-"`
